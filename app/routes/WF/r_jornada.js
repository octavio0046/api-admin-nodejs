 ...
 * @version: 1.1
 * @description: Se definen las rutas de jornada.
 * Fecha: 24/09/2019
 */
...
const abc = require('../../controllers/WF/c_jornada');
...
router.get('/', checkAuth, abc.findAll)
    ...
    router.get('/buscar/:Txt', checkAuth, abc.findLike);router.get('/buscar/:Txt', checkAuth, abc.findLike);
